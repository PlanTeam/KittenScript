...
public class KittenScriptRuntime {
    ...
    public static func run(code: [UInt8], withParameters: [String: [UInt8]], inContext context: [UInt32: [UInt8]], dynamicFunctions: [String: DynamicFunction]) throws -> [UInt8]? {
        var position = 0
        var val: [UInt8]? = nil
        var context = context
        ...
        func makeParameters(fromData code: [UInt8], position: inout Int) throws -> [String: [UInt8]] {
            var parameters = [String: [UInt8]]()
        ...
        func makeLiteral(fromData code: [UInt8], position: inout Int) throws -> [UInt8] {
        ...
        func makeExpression(fromData code: [UInt8], position: inout Int) throws -> [UInt8] {
            ...
            case 0x01:
                ...
                return try run(code: variable, withParameters: parameters, inContext: context, dynamicFunctions: dynamicFunctions) ?? [0x00]
